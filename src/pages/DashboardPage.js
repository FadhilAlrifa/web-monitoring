...
import { Factory, Calendar, Clock, LayoutDashboard, TrendingUp } from 'lucide-react';
...
    };
    ...
    // MOCK TARGET: Asumsi target bulanan tetap 26350 dari server.js, tetapi ini bisa dioptimasi dengan mengambilnya dari API Master Data.
...
                        <div className="p-4 bg-blue-50/50 rounded-lg shadow-md border border-blue-200">
                            <p className="text-sm font-medium text-blue-700 flex items-center gap-1"><TrendingUp size={16} /> Produksi MTD</p>
...
                        <div className="p-4 bg-red-50/50 rounded-lg shadow-md border border-red-200">
                            <p className="text-sm font-medium text-red-700 flex items-center gap-1"><Clock size={16} /> Total Jam Hambatan</p>
